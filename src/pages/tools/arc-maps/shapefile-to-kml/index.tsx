    ...
    <Paper sx={{ p: 3, maxWidth: 900, mx: 'auto', mt: 2 }}>
      <Stack spacing={2} mb={3}>
        ...
        <Typography variant="body2" color="text.secondary">
          Convert ESRI Shapefile vector layers (.shp, .dbf, or .zip packages)
        ...
        <Grid item xs={7}>
          ...
          >
            ...
            {geoResult ? (
              ...
              >
                Upload a .shp file or .zip shapefile archive to generate KML
                XML.
              </Box>
            )}
          </Paper>
...
function useMemoKml(
  geoResult: ParsedShapefileResult | null,
  layerName: string
): string {
