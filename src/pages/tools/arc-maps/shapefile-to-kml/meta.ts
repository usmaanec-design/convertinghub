...
export const tool = defineTool('arc-maps', {
  i18n: {
    ...
    shortDescription: 'translation:categories.arc-maps.shapefileToKml.shortDescription'
  },
  path: 'shapefile-to-kml',
  icon: 'gis:shapefile',
  keywords: ['shapefile', 'shp', 'dbf', 'kml', 'kmz', 'google earth', 'arcgis', 'arcmap', 'convert', 'gis'],
